...
- **EB AI:** The assistant bubble is an amber pill (bottom-left) displaying the logo icon + "EB AI" label. No copy in the UI or bundle claims the assistant adds items to cart — it finds products and the customer taps to add.
